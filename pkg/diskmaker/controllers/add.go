...
var AddToManagerFuncs []func(manager.Manager, *provDeleter.CleanupStatusTracker, *provCache.VolumeCache, *sync.Mutex) error

// AddToManager adds all Controllers to the Manager
func AddToManager(m manager.Manager) error {
	for _, f := range AddToManagerFuncs {

		if err := f(m, &provDeleter.CleanupStatusTracker{ProcTable: provDeleter.NewProcTable()}, provCache.NewVolumeCache(), &sync.Mutex{}); err != nil {
			return err
		}
	}
	return nil
